 ...
 * on 2017-10-27 at 11:24:24 UTC 
 * Modify at your own risk.
 */

package com.example.god.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getJokeTeller".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJokeTeller#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetJokeTeller getJokeTeller() throws java.io.IOException {
    GetJokeTeller result = new GetJokeTeller();
    initialize(result);
    return result;
  }

  public class GetJokeTeller extends MyApiRequest<com.example.god.myapplication.backend.myApi.model.JokeTeller> {

    private static final String REST_PATH = "joketeller";

    /**
     * Create a request for the method "getJokeTeller".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link GetJokeTeller#execute()} method to invoke the remote operation. <p>
     * {@link GetJokeTeller#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientR
     * equest)} must be called to initialize this instance immediately after invoking the constructor.
     * </p>
     *
     * @since 1.13
     */
    protected GetJokeTeller() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.god.myapplication.backend.myApi.model.JokeTeller.class);
    }
    ...
    @Override
    public GetJokeTeller setAlt(java.lang.String alt) {
      return (GetJokeTeller) super.setAlt(alt);
    }

    @Override
    public GetJokeTeller setFields(java.lang.String fields) {
      return (GetJokeTeller) super.setFields(fields);
    }

    @Override
    public GetJokeTeller setKey(java.lang.String key) {
      return (GetJokeTeller) super.setKey(key);
    }

    @Override
    public GetJokeTeller setOauthToken(java.lang.String oauthToken) {
      return (GetJokeTeller) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJokeTeller setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJokeTeller) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJokeTeller setQuotaUser(java.lang.String quotaUser) {
      return (GetJokeTeller) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJokeTeller setUserIp(java.lang.String userIp) {
      return (GetJokeTeller) super.setUserIp(userIp);
    }

    @Override
    public GetJokeTeller set(String parameterName, Object value) {
      return (GetJokeTeller) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.god.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.god.myapplication.backend.myApi.model.MyBean.class);
