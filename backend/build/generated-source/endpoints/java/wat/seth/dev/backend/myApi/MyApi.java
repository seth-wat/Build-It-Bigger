 ...
 * on 2017-10-30 at 15:25:27 UTC 
 * Modify at your own risk.
 */

package wat.seth.dev.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getAJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetAJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetAJoke getAJoke() throws java.io.IOException {
    GetAJoke result = new GetAJoke();
    initialize(result);
    return result;
  }

  public class GetAJoke extends MyApiRequest<wat.seth.dev.backend.myApi.model.JokeTeller> {
     ...
     * parameters, call the {@link GetAJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetAJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetAJoke() {
      super(MyApi.this, "GET", REST_PATH, null, wat.seth.dev.backend.myApi.model.JokeTeller.class);
    }
    ...
    @Override
    public GetAJoke setAlt(java.lang.String alt) {
      return (GetAJoke) super.setAlt(alt);
    }

    @Override
    public GetAJoke setFields(java.lang.String fields) {
      return (GetAJoke) super.setFields(fields);
    }

    @Override
    public GetAJoke setKey(java.lang.String key) {
      return (GetAJoke) super.setKey(key);
    }

    @Override
    public GetAJoke setOauthToken(java.lang.String oauthToken) {
      return (GetAJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public GetAJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetAJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetAJoke setQuotaUser(java.lang.String quotaUser) {
      return (GetAJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetAJoke setUserIp(java.lang.String userIp) {
      return (GetAJoke) super.setUserIp(userIp);
    }

    @Override
    public GetAJoke set(String parameterName, Object value) {
      return (GetAJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<wat.seth.dev.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, wat.seth.dev.backend.myApi.model.MyBean.class);
